...
public class Context {
     ...
     * 在当前请求中存储数据
     **/
    public static void setRequestScope(String key, Object value) {
     ...
     * 在当前客户端会话中存储数据
     **/
    public static void setSessionScope(String key, Object value) {
        RequestAttributes requestAttributes = RequestContextHolder.getRequestAttributes();
        if (requestAttributes != null) {
     ...
     * @param key 数据的key
     */
    public static Object getRequestScope(String key) {
        RequestAttributes requestAttributes = RequestContextHolder.getRequestAttributes();
        if (requestAttributes != null) {
     ...
     */
    public static <T> T getRequestScope(String key, Class<T> clazz) {
        RequestAttributes requestAttributes = RequestContextHolder.getRequestAttributes();
        if (requestAttributes != null) {
     ...
     * @throws ClassCastException 如果数据类型不匹配
     */
    public static <T> T getSessionScope(String key, Class<T> clazz) {
        RequestAttributes requestAttributes = RequestContextHolder.getRequestAttributes();
        if (requestAttributes != null) {
